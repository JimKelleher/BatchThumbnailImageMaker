...
<head>
    ...
    <title>Thumbnail Image Maker</title>
...
<body class="BaseColor">
    ...
    <div id="bannerDivFull" class="bannerDiv">
        ...
        <span id="bannerTextFull" class="bannerText">Thumbnail Image Maker</span>
    </div>
    ...
    <div id="bannerDivPhone" class="bannerDiv">
        <img src="ArtistResizeSaveRemoteImage100x100.png" alt="" />
        <br/>
        <span id="bannerTextPhone" class="bannerText">Thumbnail Image Maker</span>
    </div>
    <!-------------------------------------------------------------------------->
